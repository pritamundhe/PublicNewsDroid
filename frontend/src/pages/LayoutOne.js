...
const LayoutOne = ({ news, formatDate, startIndex }) => (
  <div className="space-y-12">
    {/* Hero Section */}
    {news[0] && (
      <div className="relative h-[450px] overflow-hidden shadow-lg rounded-xl">
        <img
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {news.slice(1).map((item, index) => (
        <div
          key={index}
          className="group bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl"
        >
          <img
